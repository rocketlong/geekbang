...
public class DefaultUriBuilder extends UriBuilder {
    ...
    public UriBuilder uri(URI uri) {
        ...
        this.queryParams.putAll(URLUtils.resolveParameters(uri.getRawQuery()));
        return this;
    }
    ...
    public UriBuilder segment(String... segments) {
        this.path = PathUtils.buildPath(this.path, segments);
        return this;
    }
    ...
    public UriBuilder matrixParam(String name, Object... values) {
        this.matrixParams.put(name, Stream.of(values).map(String::valueOf).collect(Collectors.toList()));
        return this;
    }
    ...
    public UriBuilder queryParam(String name, Object... values) {
        this.queryParams.put(name, Stream.of(values).map(String::valueOf).collect(Collectors.toList()));
        return this;
    }
